...
def create_ways(input_file):
    logging.info("Extracting OSM ways and node ids for motorways (including on-/off-ramps)")
...
def create_nodes(input_file, motorway_node_ids):
    logging.info("Extracting OSM nodes for motorways (including on-/off-ramps)")
...
if __name__ == '__main__':
    ...
    parser.add_argument("input_file", metavar="OSM_FILE", help="The input OSM file")
    parser.add_argument("database_file", metavar="OUTPUT_FILE", help="The database binary file")
